...
public class MyHomeworkController {
     ...
     * 跳转到未完成课程作业页面
     */
    @RequestMapping("/toHomeworkNotDo")
    public String toHomeworkNotDo() {
        return "system/students/homework/homework_not_do";
    }
     ...
     * 课程作业未完成信息查询
     */
    @RequestMapping("/showHomeworkNotDoList")
    @ResponseBody
    public DataGridView showHomeworkNotDoList(HttpServletRequest httpServletRequest, ExamPaperInfoVo examPaperInfoVo) {
     ...
     * 作业详情跳转
     */
    @RequestMapping("/showHomeworkInfo")
    public String showHomeworkInfo(HttpServletRequest httpServletRequest, @RequestParam("id")Integer id) {
        ...
        return "system/students/homework/homework_info";
    }

    /**
     * 跳转到选择题页面
     */
    @RequestMapping("/doSingleQuestion")
    public String doSingleQuestion(HttpServletRequest httpServletRequest,@RequestParam("id")Integer paperId) {
        Students students = (Students) httpServletRequest.getSession().getAttribute("user");
        if(students==null)
            return "/toLogin";
        try {
        ...
        return "system/students/homework/single_question_info";
    }

    /**
     * 提交选择题
     */
    @RequestMapping("/submitSingleQuestion")
    @ResponseBody
    public ResultObj submitSingleQuestion(HttpServletRequest httpServletRequest){
     ...
     * 跳转到填空题页面
     */
    @RequestMapping("/doBlankQuestion")
    public String doBlankQuestion(HttpServletRequest httpServletRequest,@RequestParam("id")Integer paperId) {
        Students students = (Students) httpServletRequest.getSession().getAttribute("user");
        if(students==null)
            return "/toLogin";
        try {
        ...
        return "system/students/homework/blank_question_info";
    }

    /**
     * 提交填空题
     */
    @RequestMapping("/submitBlankQuestion")
    @ResponseBody
    public ResultObj submitBlankQuestion(HttpServletRequest httpServletRequest){
        ExamPaperinfo examPaperinfo = (ExamPaperinfo) httpServletRequest.getSession().getAttribute("paper");
        Students students = (Students)  httpServletRequest.getSession().getAttribute("user");
        if(examPaperinfo==null||students==null)
            return new ResultObj(-1,"提交失败");
     ...
     * 跳转到代码题页面
     */
    @RequestMapping("/doCodeQuestion")
    public String doCodeQuestion(HttpServletRequest httpServletRequest,@RequestParam("id")Integer paperId) {
        Students students = (Students) httpServletRequest.getSession().getAttribute("user");
        if(students==null)
            return "/toLogin";
        try {
        ...
        return "system/students/homework/code_question_info";
    }

    /**
     * 代码调试
     */
    @RequestMapping("/ExerciseHomeworkTest")
    @ResponseBody
    public ResultObj ExerciseHomeworkTest(@RequestParam("content")String content,
        ...
        resultObj = exerciseJudgeCore.executeCode(content,courseType,exerciseId,studentId,1,paperId);
     ...
     * 提交代码
     */
    @RequestMapping("/submitExerciseQuestion")
    @ResponseBody
    public ResultObj submitExerciseQuestion(HttpServletRequest httpServletRequest){
        ExamPaperinfo examPaperinfo = (ExamPaperinfo) httpServletRequest.getSession().getAttribute("paper");
        Students students = (Students)  httpServletRequest.getSession().getAttribute("user");
        if(examPaperinfo==null||students==null)
            return new ResultObj(-1,"提交失败");
        ...
        for (Integer id : hashMap.keySet()){
            //key是题目id,value是回答
            System.out.println("id:"+id);
            System.out.println("answer:"+hashMap.get(id));
            ...
            if(list==null){
                ...
                resultObj = exerciseJudgeCore.executeCode(answer,courseType,id,students.getStudentId(),1,examPaperinfo.getId());
    ...
    @ResponseBody
    public ResultObj submitHomework(HttpServletRequest httpServletRequest){
        ExamPaperinfo examPaperinfo = (ExamPaperinfo) httpServletRequest.getSession().getAttribute("paper");
        Students students = (Students)  httpServletRequest.getSession().getAttribute("user");
        if(examPaperinfo==null||students==null)
            return new ResultObj(-1,"提交失败");
     ...
     * 跳转到完成课程作业页面
     */
    @RequestMapping("/toHomeworkDone")
    public String toHomeworkDone() {
        return "system/students/homework/homework_done";
    }

    /**
     * 课程作业完成信息查询
     */
    @RequestMapping("/showHomeworkDoneList")
    @ResponseBody
    public DataGridView showHomeworkDoneList(HttpServletRequest httpServletRequest, ExamScoreInfoVo examScoreInfoVo,
    ...
    public String toHomeworkAnswer(HttpServletRequest httpServletRequest, @RequestParam("id")Integer paperId, Model model) {
        Students students = (Students) httpServletRequest.getSession().getAttribute("user");
        ...
        return "system/students/homework/answer_detail";
    }
